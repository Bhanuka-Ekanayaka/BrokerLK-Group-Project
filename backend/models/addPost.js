...
const CreateBoardingRoom = async (formData) => {
    let connection;
    ...
    try {
        ...
        return { success: true, message: 'Transaction is Complete',post_ID:post_ID };
...
const UploadImageBoardingRoom = async(ImageData,post_ID)=>{
