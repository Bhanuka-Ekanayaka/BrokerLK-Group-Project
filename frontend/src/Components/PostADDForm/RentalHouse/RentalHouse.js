...
const RentalHouse = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (form.checkValidity() === false) {
            ...
            try {
                const responsePostData = await axios.post('http://localhost:5001/postadd/rental-house', formData);
                console.log('Form Data Insert Successfully', responsePostData.data);




                const responseUplodPhotos = await axios.post('http://localhost:5001/postadd/rental-house/upload', formPhoto, {
                    headers: {
                    ...
                    <Form noValidate validated={validated} onSubmit={handleSubmit}>
                        <Row>
                            ...
                            <Form.Group as={Col} controlId="formGridState">
                                ...
                                <Form.Control type="number" placeholder="100" value={room} onChange={(e) => setRoom(e.target.value)} min='0' required />
                                <Form.Control.Feedback type="invalid">
