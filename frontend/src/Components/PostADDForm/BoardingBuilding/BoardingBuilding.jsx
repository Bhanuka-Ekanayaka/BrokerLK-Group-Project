                    ...
                    <Form>
                        <Row className='mb-3'>
                            ...
                            <Form.Group as={Col} controlId="formGridNumber">
                                ...
                                <Form.Control type='number' placeholder='05' min='0' required />
                            </Form.Group>
                        </Row>
                        <Row className='mb-3'>
                            ...
                            <Form.Group as={Col} controlId="formGridBathrooms">
                                ...
                                <Form.Control type="number" placeholder='1' min='0' required />
                            </Form.Group>
                            <Form.Group as={Col} controlId="formGridTenants">
                        ...
                        <Row className='mb-3'>
                            ...
                            <Form.Group as={Col} controlId="formGridKitchen">
                                <Form.Label>Kitchen <small className='text-muted'>*Rs:</small></Form.Label>
