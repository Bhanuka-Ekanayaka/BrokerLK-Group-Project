...
const SearchBar = ({ postData }) => {
    ...
    useEffect(() => {
        ...
        console.log(is_kitchen, 'value of is kitchen');
    }, [searchText, minTenants, minBed, size, price, is_kitchen])
                                    ...
                                    <Navbar.Collapse id="basic-navbar-nav">
                                        ...
                                        <Form.Group as={Col}  lg={3} className="d-flex justify-content-center align-items-center" >
                                            <InputGroup >
                                                ...
                                                />
                                                <Button className="btn-danger" id="button-addon2" type='submit' as={Link} to='/rental-post'>
